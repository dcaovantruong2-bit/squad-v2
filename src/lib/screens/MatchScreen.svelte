    ...
    <section class="pitch-zone">
      ...
      <div class="match-pitch">
        ...
        {#each $game.field || [] as entry, i}
          {@const layout = [{x:50,y:90},{x:12,y:74},{x:38,y:78},{x:62,y:78},{x:88,y:74},{x:12,y:44},{x:38,y:50},{x:62,y:50},{x:88,y:44},{x:38,y:14},{x:62,y:14}]}
          <div class="player-dot" style={`left:${layout[i]?.x || 50}%;top:clamp(26px, ${layout[i]?.y || 50}%, calc(100% - 26px))`}>
